...
def main():
 ...
 #          + str(usableMem) + "GB" + " disks=" + str(disks))
  ...
  #Yarn
  #log.info("\n\n<property>\n	<name>yarn.scheduler.minimum-allocation-mb</name>\n	<value>" + str(container_ram) + "</value>	\n</property>")
  #log.info("\n\n<property>\n	<name>yarn.scheduler.maximum-allocation-mb</name>\n	<value>" + str(containers*container_ram) + "</value>	\n</property>")
  ...
  # Esses abaixo mudam
  log.info("\n\n	<property>\n		<name>mapreduce.map.memory.mb</name>\n		<value>" + str(map_memory) + "</value>	\n	</property>")
  log.info("\n\n	<property>\n		<name>mapreduce.map.java.opts</name>\n		<value>-Xmx" + str(int(0.8 * map_memory)) + "m</value>	\n	</property>")
  log.info("\n\n	<property>\n		<name>mapreduce.reduce.memory.mb</name>\n		<value>" + str(reduce_memory) + "</value>	\n	</property>")
  log.info("\n\n	<property>\n		<name>mapreduce.reduce.java.opts</name>\n		<value>-Xmx" + str(int(0.8 * reduce_memory)) + "m</value>	\n	</property>")
  log.info("\n\n	<property>\n		<name>yarn.app.mapreduce.am.resource.mb</name>\n		<value>" + str(am_memory) + "</value>	\n	</property>")
  log.info("\n\n	<property>\n		<name>yarn.app.mapreduce.am.command-opts</name>\n		<value>-Xmx" + str(int(0.8*am_memory)) +"m</value>	\n	</property>")
  log.info("\n\n	<property>\n		<name>mapreduce.task.io.sort.mb</name>\n		<value>" + str(int(0.4 * map_memory)) + "</value>	\n	</property>")
  log.info("\n\n	<property>\n		<name>mapred.child.java.opts</name>\n		<value>-Xmx" + str(int(0.8 * map_memory)) + "m</value>	\n	</property>")
  log.info("\n\n	<property>\n		<name>mapreduce.task.timeout</name>\n		<value>0</value>	\n	</property>")

  # Esses 2 abaixo sao Fixo
